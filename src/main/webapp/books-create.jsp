...
<%
    ...
    List<BookStatus> statusBook = (List<BookStatus>) request.getAttribute("status");
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <form action="<%= request.getContextPath() %>/books/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="field_title">
                </div>

                <div class="mb-3">
                    <label for="categoria" class="form-label">Categoria: </label>
                    <input type="text" class="form-control" id="categoria" name="field_category">
                </div>

                <div class="mb-3">
                    <label for="dataPublicacao" class="form-label">Data de Publicação: </label>
                    <input type="date" class="form-control" id="dataPublicacao" name="field_publicationDate" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="field_status" id="status">
                        ...
                        <% for (BookStatus status: statusBook) { %>
